...
class CommentsWidget extends StatelessWidget {
    ...
    return Container(
      ...
      child: Card(
        ...
        child: Column(
          ...
          child: Column(
            children: [
              _title(context, data.data.result.comments.productCommentSummary),
              _hotCommentTags(context, data.data.result.comments.hotCommentTagStatistics),
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xfff5503a), Color(0xfffad1cb)],
          ...
          Padding(
            ...
            child: Text('评价', style: TextStyle(fontWeight: FontWeight.w600, fontSize: ScreenUtil().setSp(36)))
          ),
          Padding(
          ...
          Container(
            child: Row(
              ...
              children: [
                Text('好评度 ${data.goodRateShow}%', style: TextStyle(color: Color(0xff8c8c8c), fontSize: ScreenUtil().setSp(32))),
  ...
  Widget _hotCommentTags(context, data) {
    if(data.length != 0) {
      ...
      return Container(
        margin: idx != data.length - 1 ? EdgeInsets.only(right: 8.0) : EdgeInsets.all(0),
        child: InputChip(
  ...
  Widget _userInfoScore(context, scores) {
    ...
    for(var i = 0; i < scores; i++) {
      _list.add(Icon(Icons.star, color: Theme.of(context).primaryColor, size: 16));
    }
    return Padding(
    ...
    if(data.commentImages.length != 0) {
      List<Widget> list = data.commentImages.map<Widget>((item) {
        ...
        return Container(
          ...
          child: ClipRRect(
            borderRadius: idx == 0 ? BorderRadius.only(topLeft: Radius.circular(10.0), bottomLeft: Radius.circular(10.0))
            : idx == data.commentImages.length - 1 ? BorderRadius.only(topRight: Radius.circular(10.0), bottomRight: Radius.circular(10.0))
            : BorderRadius.zero,
            child: InkWell(
              onTap: () {print('comment image');},
  ...
  Widget _subdisc(context, data) {
    return Container(
      ...
      padding: EdgeInsets.only(top: 6.0),
      child: Text(
        '${data.productColor}, ${data.productSize}',
