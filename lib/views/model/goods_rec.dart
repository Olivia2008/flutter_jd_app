class GoodsRecModel {
  ...
  GoodsRecModel({this.result, this.code, this.message, this.data});

  GoodsRecModel.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    code = json['code'];
...
class Data {
  String newSkuId;
  List<ListSkuRelation> listSkuRelation;
  int totalCount;

  Data({this.newSkuId, this.listSkuRelation, this.totalCount});

  Data.fromJson(Map<String, dynamic> json) {
    newSkuId = json['newSkuId'];
    if (json['listSkuRelation'] != null) {
      listSkuRelation = new List<ListSkuRelation>();
      json['listSkuRelation'].forEach((v) {
        listSkuRelation.add(new ListSkuRelation.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.listSkuRelation != null) {
      data['listSkuRelation'] =
          this.listSkuRelation.map((v) => v.toJson()).toList();
    }
...
class ListSkuRelation {
  ...
  ListSkuRelation.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    skuId = json['skuId'];
